...
unsigned int do_2a_gain_gc16b3c2(struct EEPROM_DRV_FD_DATA *pdata,
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x0001, 0x001, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x0000001E, 0x0000000E, do_2a_gain_gc16b3c2},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT gc16b3c2_mtk_eeprom = {
	.name = "gc16b3c2_mtk_eeprom",
