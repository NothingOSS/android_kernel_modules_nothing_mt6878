...
unsigned int do_2a_gain_gc16b3cofilm(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);

unsigned int do_part_number_gc16b3cofilm(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x0001, 0x001, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00000008, 0x00000014, do_part_number_gc16b3cofilm},
		{0x00000001, 0x00000030, 0x0000074C, do_single_lsc},
		{0x00000001, 0x0000001E, 0x0000000E, do_2a_gain_gc16b3cofilm},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT gc16b3cofilm_mtk_eeprom = {
	.name = "gc16b3cofilm_mtk_eeprom",
		...
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData)
{
	...
	if (read_data(pdata, pCamCalData->sensorID, pCamCalData->deviceID,
		...
		must_log("GC16B3COFILM_SENSOR_ID  == pCamCalData->sensorIDmodule ID = 0x%x,0x09 from XL,0x0A from OFILM \n",pCamCalData->PartNumber[0]);
