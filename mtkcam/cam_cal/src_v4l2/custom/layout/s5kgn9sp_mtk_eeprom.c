...
unsigned int do_2a_gain_s5kgn9(struct EEPROM_DRV_FD_DATA *pdata,
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000001, 0x010b00ff, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00000026, 0x00000017, do_2a_gain_s5kgn9},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT s5kgn9sp_mtk_eeprom = {
	.name = "s5kgn9sp_mtk_eeprom",
