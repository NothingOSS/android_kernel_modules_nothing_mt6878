 ...
 *============================================================================
 ****************************************************************************/
#include "ov50d40ofilmmipiraw_Sensor.h"

#define LOG_TAG "[ov50d40ofilm]"
#define LOG_INF(format, args...) pr_info(LOG_TAG "[%s] " format, __func__, ##args)

//static void set_sensor_cali(void *arg);
//static int get_sensor_temperature(void *arg);
static void set_group_hold(void *arg, u8 en);
static void ov50d40ofilm_set_dummy(struct subdrv_ctx *ctx);
static int ov50d40ofilm_set_max_framerate_by_scenario(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int ov50d40ofilm_get_ana_gain_table(struct subdrv_ctx *ctx,u8 *para,u32 *len);
static u16 get_gain2reg(u32 gain);
//static int ov50d40ofilm_seamless_switch(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int ov50d40ofilm_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int init_ctx(struct subdrv_ctx *ctx,	struct i2c_client *i2c_client, u8 i2c_write_id);
static int ov50d40ofilm_get_imgsensor_id(struct subdrv_ctx *ctx, u8 *para, u32 *len);
static int get_imgsensor_id(struct subdrv_ctx *ctx, u32 *para);
static int ov50d40ofilm_open(struct subdrv_ctx *ctx);

/* STRUCT */

static struct subdrv_feature_control feature_control_list[] = {
	{SENSOR_FEATURE_SET_TEST_PATTERN, ov50d40ofilm_set_test_pattern},
	//{SENSOR_FEATURE_SEAMLESS_SWITCH, ov50d40ofilm_seamless_switch},
	{SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO, ov50d40ofilm_set_max_framerate_by_scenario},
	{SENSOR_FEATURE_GET_ANA_GAIN_TABLE,ov50d40ofilm_get_ana_gain_table},
	{SENSOR_FEATURE_CHECK_SENSOR_ID, ov50d40ofilm_get_imgsensor_id},
};
...
// 		.xtalk_support = TRUE,
// 		.xtalk_table = data_xtalk_ov50d40ofilm,
// 		.xtalk_size = ARRAY_SIZE(data_xtalk_ov50d40ofilm),
...
static struct subdrv_mode_struct mode_struct[] = {
	{
		...
		.mode_setting_table = addr_data_pair_preview_ov50d40ofilm,
		.mode_setting_len = ARRAY_SIZE(addr_data_pair_preview_ov50d40ofilm),
	...
	},
	{
		...
		.mode_setting_table = addr_data_pair_capture_ov50d40ofilm,
		.mode_setting_len = ARRAY_SIZE(addr_data_pair_capture_ov50d40ofilm),
		.seamless_switch_group = 1,
		.seamless_switch_mode_setting_table = addr_data_pair_capture_ov50d40ofilm,
		.seamless_switch_mode_setting_len = ARRAY_SIZE(addr_data_pair_capture_ov50d40ofilm),
		.hdr_mode = HDR_NONE,
		.raw_cnt = 1,
		.exp_cnt = 1,
		.pclk = 100000000,
	...
	},
	{
		...
		.mode_setting_table = addr_data_pair_video_ov50d40ofilm,
		.mode_setting_len = ARRAY_SIZE(addr_data_pair_video_ov50d40ofilm),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = addr_data_pair_hs_video_ov50d40ofilm,
		.mode_setting_len = ARRAY_SIZE(addr_data_pair_hs_video_ov50d40ofilm),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = addr_data_pair_slim_video_ov50d40ofilm,
		.mode_setting_len = ARRAY_SIZE(addr_data_pair_slim_video_ov50d40ofilm),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = addr_data_pair_ov50d40ofilm_custom1,
		.mode_setting_len = ARRAY_SIZE(addr_data_pair_ov50d40ofilm_custom1),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = addr_data_pair_ov50d40ofilm_custom2,
		.mode_setting_len = ARRAY_SIZE(addr_data_pair_ov50d40ofilm_custom2),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
	...
	},
	{
		...
		.mode_setting_table = addr_data_pair_ov50d40ofilm_custom3,
		.mode_setting_len = ARRAY_SIZE(addr_data_pair_ov50d40ofilm_custom3),
		.seamless_switch_group = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_table = PARAM_UNDEFINED,
		.seamless_switch_mode_setting_len = PARAM_UNDEFINED,
		.hdr_mode = HDR_NONE,
...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = OV50D40OFILM_SENSOR_ID,
	...
	.ana_gain_type = 1,
	.ana_gain_step = 4,
	.ana_gain_table = ov50d40ofilm_62_ana_gain_table,
	.ana_gain_table_size = sizeof(ov50d40ofilm_62_ana_gain_table),
	.min_gain_iso = 100,
	.exposure_def = 0x3D0,
	.exposure_min = 20,
	...
	.init_setting_table = addr_data_pair_init_ov50d40ofilm,
	.init_setting_len = ARRAY_SIZE(addr_data_pair_init_ov50d40ofilm),
	.mode = mode_struct,
...
const struct subdrv_entry ov50d40ofilm_mipi_raw_entry = {
	.name = "ov50d40ofilm_mipi_raw",
	.id = OV50D40OFILM_SENSOR_ID,
	.pw_seq = pw_seq,
...
static int ov50d40ofilm_get_imgsensor_id(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	while (ctx->s_ctx.i2c_addr_table[i] != 0xFF) {
		...
		do {
			...
			LOG_INF("[ov50d40ofilm]: i2c write id: 0x%x, sensor id: 0x%x, module id: 0x%x\n",
			...
			LOG_INF("[ov50d40ofilm]: Read sensor id fail! i2c write id: 0x%x, sensor id: 0x%x\n",
...
static int get_imgsensor_id(struct subdrv_ctx *ctx,u32 *para)
{
	...
	while (ctx->s_ctx.i2c_addr_table[i] != 0xFF) {
		...
		do {
			...
			LOG_INF("[ov50d40ofilm]: i2c write id: 0x%x, sensor id: 0x%x, module id: 0x%x\n",
					ctx->i2c_write_id, sensor_id, module_id);
			if (sensor_id == ctx->s_ctx.sensor_id && (module_id == 0x0a)) {
				LOG_INF("[ov50d40ofilm]: i2c write id: 0x%x, sensor id: 0x%x, module id: 0x%x\n",
					ctx->i2c_write_id, sensor_id, module_id);
				return ERROR_NONE;
			}
	...
	switch (scenario_id) {
		...
		case SENSOR_SCENARIO_ID_HIGHSPEED_VIDEO:
			if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
				*(feature_data + 0) =
					sizeof(ov50d40ofilm_ana_gain_table);
			} else {
				memcpy((void *)(uintptr_t) (*(feature_data + 1)),
				(void *)ov50d40ofilm_ana_gain_table,
				sizeof(ov50d40ofilm_ana_gain_table));
			}
		break;
		default :
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
				*(feature_data + 0) =
					sizeof(ov50d40ofilm_62_ana_gain_table);
			} else {
				memcpy((void *)(uintptr_t) (*(feature_data + 1)),
				(void *)ov50d40ofilm_62_ana_gain_table,
				sizeof(ov50d40ofilm_62_ana_gain_table));
			}
		break;
		}
...
// 	i2c_table_write(ctx, addr_data_pair_seamless_switch_step1_ov50d40ofilm,
// 		ARRAY_SIZE(addr_data_pair_seamless_switch_step1_ov50d40ofilm));
// 	i2c_table_write(ctx,
...
// 	}
// 	i2c_table_write(ctx, addr_data_pair_seamless_switch_step2_ov50d40ofilm,
// 		ARRAY_SIZE(addr_data_pair_seamless_switch_step2_ov50d40ofilm));
// 	if (ae_ctrl) {
// 		set_shutter(ctx, ae_ctrl[10]);
// 		set_gain(ctx, ae_ctrl[15]);
// 	}
// 	i2c_table_write(ctx, addr_data_pair_seamless_switch_step3_ov50d40ofilm,
// 		ARRAY_SIZE(addr_data_pair_seamless_switch_step3_ov50d40ofilm));
...
static int ov50d40ofilm_set_test_pattern(struct subdrv_ctx *ctx, u8 *para, u32 *len)
{
	...
	switch (mode) {
	case OFILIMPATTERN_MODE_COLOR_BAR:
		subdrv_i2c_wr_u8(ctx, 0x50c1, 0x01);
		break;
	case OFILIMPATTERN_MODE_NO_ACCESS:
	case OFILIMPATTERN_MODE_EXPERT:
