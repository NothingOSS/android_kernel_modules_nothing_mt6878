 ...
 * Filename:
 * ---------
 *	 s5kgn9spofxian_mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *============================================================================
 ****************************************************************************/
#include "s5kgn9spofxian_mipiraw_Sensor.h"
...
int s5kgn9ofxian_common_open(struct subdrv_ctx *ctx);
...
const struct subdrv_entry s5kgn9spofxian_mipi_raw_entry = {
	.name = "s5kgn9spofxian_mipi_raw",
	.id = S5KGN9SPOFXIAN_SENSOR_ID,
	.pw_seq = pw_seq,
	...
	while (ctx->s_ctx.i2c_addr_table[i] != 0xFF) {
		...
		do {
			...
			*sensor_id +=1;
			...
			if (*sensor_id == S5KGN9SPOFXIAN_SENSOR_ID) {
