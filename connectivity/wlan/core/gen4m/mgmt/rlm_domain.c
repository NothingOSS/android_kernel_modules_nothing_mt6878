...
static const uint16_t g_u2CountryGroup32[] = {
	...
	COUNTRY_CODE_MO, COUNTRY_CODE_KZ, COUNTRY_CODE_PE, COUNTRY_CODE_PK,
	COUNTRY_CODE_SG
};
...
static const uint16_t g_u2IndoorType0[] = {
	...
	COUNTRY_CODE_JP, COUNTRY_CODE_JE, COUNTRY_CODE_GE, COUNTRY_CODE_BD,
...
static const uint16_t g_u2IndoorType1[] = {
	...
	COUNTRY_CODE_CA, COUNTRY_CODE_PE, COUNTRY_CODE_MX, COUNTRY_CODE_KR,
};

/* group for countries that marked channel 100~128 as indoor channel */
static const uint16_t g_u2IndoorType2[] = {
	COUNTRY_CODE_KZ, COUNTRY_CODE_MN, COUNTRY_CODE_BY,
};
...
static const uint16_t g_u2IndoorType4[] = {
	COUNTRY_CODE_KZ, COUNTRY_CODE_MN,
};
