 ...
 ********************************************************************************
 */
unsigned int mt6878_chip_info[CHIP_INFO_SIZE];
/*******************************************************************************
...
int connsys_a_die_cfg_mt6878(unsigned int curr_status, unsigned int next_status)
{
	...
	connsys_a_die_efuse_read_get_efuse_info_mt6878_gen(
			curr_status, next_status, mt6878_chip_info,sysram_efuse_list,
	...
	pr_info("Chip info = [%08x, %08x, %08x]",
		mt6878_chip_info[0], mt6878_chip_info[1], mt6878_chip_info[2]);
...
void splitValues(unsigned int val1, unsigned int val2, unsigned char *array) {
...
static int consys_get_chip_info(char *buf, unsigned int size, int print_log)
{
	...
	splitValues(mt6878_chip_info[1], mt6878_chip_info[2], split_info_list);
...
int consys_get_chip_info_mt6878(char *buf, unsigned int size)
{
