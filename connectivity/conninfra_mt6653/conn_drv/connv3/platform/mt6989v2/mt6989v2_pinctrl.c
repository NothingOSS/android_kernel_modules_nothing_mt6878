...
********************************************************************************
*/
int connv3_plt_pinctrl_init_mt6989v2(struct platform_device *pdev);
int connv3_plt_pinctrl_deinit_mt6989v2(void);
int connv3_plt_pinctrl_setup_pre_mt6989v2(void);
int connv3_plt_pinctrl_setup_done_mt6989v2(void);
int connv3_plt_pinctrl_remove_mt6989v2(void);
int connv3_plt_pinctrl_dfd_trigger_mt6989v2(bool enable);

const struct connv3_platform_pinctrl_ops g_connv3_platform_pinctrl_ops_mt6989v2 = {
	.pinctrl_init = connv3_plt_pinctrl_init_mt6989v2,
	.pinctrl_deinit = connv3_plt_pinctrl_deinit_mt6989v2,
	.pinctrl_setup_pre = connv3_plt_pinctrl_setup_pre_mt6989v2,
	.pinctrl_setup_done = connv3_plt_pinctrl_setup_done_mt6989v2,
	.pinctrl_remove = connv3_plt_pinctrl_remove_mt6989v2,
	.pinctrl_dfd_trigger = connv3_plt_pinctrl_dfd_trigger_mt6989v2,
};
...
int connv3_plt_pinctrl_setup_pre_mt6989v2(void)
{
	...
	connv3_plt_pinctrl_dfd_trigger_mt6989v2(false);
	return 0;
}
