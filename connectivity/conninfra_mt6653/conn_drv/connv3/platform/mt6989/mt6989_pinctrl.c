...
int connv3_plt_pinctrl_dfd_trigger_mt6989_mt6653(bool enable);
...
const struct connv3_platform_pinctrl_ops g_connv3_platform_pinctrl_ops_mt6989_mt6653 = {
	.pinctrl_init = connv3_plt_pinctrl_init_mt6989,
	.pinctrl_deinit = connv3_plt_pinctrl_deinit_mt6989,
	.pinctrl_setup_pre = connv3_plt_pinctrl_setup_pre_mt6989,
	.pinctrl_setup_done = connv3_plt_pinctrl_setup_done_mt6989,
	.pinctrl_remove = connv3_plt_pinctrl_remove_mt6989,
	.pinctrl_dfd_trigger = connv3_plt_pinctrl_dfd_trigger_mt6989_mt6653,
};
...
int connv3_plt_pinctrl_dfd_trigger_mt6989_mt6653(bool enable)
{
	...
	/* enable == 1: PU DFD pin
	 * enable == 0: PD DFD pin
	 * for 6989 + 6653 case, it should be GPIO147
	 */
	if (!g_dfd_init_done) {
