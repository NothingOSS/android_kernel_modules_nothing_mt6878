...
#include "include/mt6878_coredump.h"
...
struct consys_platform_coredump_ops g_consys_platform_coredump_ops_mt6878 = {
	.consys_coredump_get_platform_config = consys_plt_coredump_get_platform_config_mt6878,
	.consys_coredump_get_platform_chipid = consys_plt_coredump_get_platform_chipid_mt6878,
	.consys_coredump_get_task_string = consys_plt_coredump_get_task_string_mt6878,
	.consys_coredump_get_sys_name = consys_plt_coredump_get_sys_name_mt6878,
	.consys_coredump_is_host_view_cr = consys_plt_coredump_is_host_view_cr_mt6878,
	.consys_coredump_is_host_csr_readable = consys_plt_coredump_is_host_csr_readable_mt6878,
	.consys_coredump_get_cr_category = consys_plt_coredump_get_cr_category_mt6878,
	.consys_coredump_get_emi_offset = consys_plt_coredump_get_emi_offset_mt6878,
	.consys_coredump_get_emi_phy_addr = consys_plt_coredump_get_emi_phy_addr_mt6878,
	.consys_coredump_get_mcif_emi_phy_addr = consys_plt_coredump_get_mcif_emi_phy_addr_mt6878,
	.consys_coredump_setup_dynamic_remap = consys_plt_coredump_setup_dynamic_remap_mt6878,
	.consys_coredump_remap = consys_plt_coredump_remap_mt6878,
	.consys_coredump_unmap = consys_plt_coredump_unmap_mt6878,
	.consys_coredump_get_tag_name = consys_plt_coredump_get_tag_name_mt6878,
	.consys_coredump_is_supported = consys_plt_coredump_is_supported_mt6878,
};

struct coredump_hw_config *consys_plt_coredump_get_platform_config_mt6878(int conn_type)
{
...
unsigned int consys_plt_coredump_get_platform_chipid_mt6878(void)
{
	return 0x6878;
}

char *consys_plt_coredump_get_task_string_mt6878(int conn_type, unsigned int task_id)
{
	if (conn_type < 0 || conn_type >= CONN_DEBUG_TYPE_END) {
		pr_err("Incorrect type: %d\n", conn_type);
		return NULL;
...
char *consys_plt_coredump_get_sys_name_mt6878(int conn_type)
{
	if (conn_type < 0 || conn_type >= CONN_DEBUG_TYPE_END) {
		pr_err("Incorrect type: %d\n", conn_type);
		return NULL;
...
bool consys_plt_coredump_is_host_view_cr_mt6878(unsigned int addr, unsigned int *host_view)
{
...
bool consys_plt_coredump_is_host_csr_readable_mt6878(void)
{
	bool ret = false;
	unsigned int r1, r2;
...
enum cr_category consys_plt_coredump_get_cr_category_mt6878(unsigned int addr)
{
...
unsigned int consys_plt_coredump_get_emi_offset_mt6878(int conn_type)
{
...
void consys_plt_coredump_get_emi_phy_addr_mt6878(phys_addr_t *base, unsigned int *size)
{
	conninfra_get_emi_phy_addr(CONNSYS_EMI_FW, base, size);
}

void consys_plt_coredump_get_mcif_emi_phy_addr_mt6878(phys_addr_t *base, unsigned int *size)
{
	conninfra_get_emi_phy_addr(CONNSYS_EMI_MCIF, base, size);
}

unsigned int consys_plt_coredump_setup_dynamic_remap_mt6878(int conn_type, unsigned int idx,
...
void __iomem *consys_plt_coredump_remap_mt6878(int conn_type, unsigned int base,
	unsigned int length)
{
	void __iomem *vir_addr = 0;
...
void consys_plt_coredump_unmap_mt6878(void __iomem *vir_addr)
{
	iounmap(vir_addr);
}

char *consys_plt_coredump_get_tag_name_mt6878(int conn_type)
{
	if (conn_type < 0 || conn_type >= CONN_DEBUG_TYPE_END) {
...
bool consys_plt_coredump_is_supported_mt6878(unsigned int drv)
{
	bool ret = false;
