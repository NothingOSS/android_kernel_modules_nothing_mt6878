...
#include "../mt6989/include/mt6989.h"
#include "../mt6989/include/mt6989_atf.h"
#include "../mt6989/include/mt6989_pos.h"
#include "../mt6989/include/mt6989_soc.h"
#include "include/mt6989v2_connsyslog.h"

struct consys_hw_ops_struct g_consys_hw_ops_mt6989v2_atf = {
...
extern struct consys_platform_coredump_ops g_consys_platform_coredump_ops_mt6989v2_atf;

const struct conninfra_plat_data mt6989v2_plat_data_atf = {
	...
	.platform_coredump_ops = &g_consys_platform_coredump_ops_mt6989v2_atf,
	.connsyslog_config = &g_connsyslog_config_mt6989v2,
};
